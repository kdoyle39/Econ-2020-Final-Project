...
## Regions
merged_dt[, Region := 
            ifelse(Territory %in% c("Kalisz governorate", "Warsaw governorate", "Vilna governorate", "Grodno governorate", "Kovno governorate", "Kurland governorate", "Livonia governorate", "Łomża governorate", "Lublin governorate", "Minsk governorate", "Mogilev governorate", "Podolsk governorate", "Pskov governorate", "Radom governorate", "Suwałki governorate", "Estonia governorate", "Kielce governorate", "Piotrków governorate", "Płock governorate", "Siedlce governorate", "St. Petersburg governorate", "Vitebsk governorate", "Volhynian governorate", "Vyborg governorate"), "Western Region",
            ifelse(Territory %in% c("Arkhangelsk governorate", "Vladimir governorate", "Vologda governorate", "Yaroslavl governorate", "Moscow governorate", "Nizhny Novgorod governorate", "Novgorod governorate", "Olonets governorate", "Orel governorate", "Penza governorate", "Ryazan governorate", "Smolensk governorate", "Tver governorate", "Tula governorate", "Kaluga governorate", "Kazan governorate", "Kostroma governorate", "Simbirsk governorate", "Ural region", "Samara governorate", "Tambov governorate", "Viatka governorate"), "Central Region",
            ifelse(Territory %in% c("Elisabethpol governorate", "Ekaterinoslav governorate", "Kharkov governorate", "Kherson governorate", "Kursk governorate", "Odessa governorate", "Poltava governorate", "Saratov governorate", "Stavropol governorate", "Taurida governorate", "Bessarabia governorate", "Chernigov governorate", "Don Cossack host lands", "Kiev governorate", "Voronezh governorate"), "Southern Region",
            ifelse(Territory %in% c("Amur region", "Irkutsk governorate", "Primorskaya region", "Sakhalin island", "Transbaikal region", "Yakutsk region", "Enisei governorate", "Perm governorate", "Tobolsk governorate", "Orenburg governorate", "Tomsk governorate", "Ufa governorate"), "Eastern Region",
            ifelse(Territory %in% c("Astrakhan governorate", "Baku governorate", "Akmola region", "Samarkand region", "Syr-Darya region", "Fergana region", "Semipalatinsk region", "Semirechye region", "Turgay region", "Terek region", "Dagestan region", "Erevan governorate", "Kars governorate", "Tiflis governorate incl. Zakatalskii district", "Black Sea governorate", "Kutaisi governorate incl. Sukhumi district", "Transcaspian region", "Kuban region"), "Central Asia and Caucasus", NA)))))]
